...
Все примеры и SQL-запросы основаны на таблице `players`. Если вы хотите не только читать книгу, но и выполнять все запросы самостоятельно, воспользуйтесь интерактивной SQL-песочницей, доступной в рамках курса «SQL Введение».
